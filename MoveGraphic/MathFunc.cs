...
namespace MoveGraphic
{
    internal static class MathFunc
    {
        ...
        {
            return Math.Round(Math.Sqrt(Math.Pow(obj.InternalStartPoint.X - obj.InternalStartPoint.Y, 2) + Math.Pow(obj.InternalEndPoint.X - obj.InternalEndPoint.Y, 2)), round);
        }
